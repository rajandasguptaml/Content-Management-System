...
@section('indexcontent')
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left"><b>Upload Ariticle </b></h4>  
                        </div>
                    </div>
        ...
        @endif --}}
                ...
                <form  method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label >Article/Littarature/PDF</label>
                    <div class="custom-file">
                        <label class="custom-file-label" for="inputGroupFile03">Choose File</label>
                        <input type="file" name="pdf" class="custom-file-input" id="inputGroupFile03">

                        <span style= "color: rgb(9, 112, 138)"> @error ('pdf'){{$message}}@enderror</span>
                    </div>
                    </div>
                    ...
                    <input type="submit"  class="btn btn-primary"></input>
                        ...
                        <a href="/book"> <button type="button" class="btn btn-primary">Show Content</button></a>
