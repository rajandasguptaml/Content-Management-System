...
@section('indexcontent')
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left"><b>Littareture</b></h4>   
                        </div>
                    </div>
                ...
                <table class="table table-stripped table-bordered table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- <th> <img src="{{asset('/storage/'.$contentshow->pdf)}}" width="100px" height="100px" alt="Image"></th> --}}
            ...
            <div class="container">
                ...
                <a href="/pdfformshow"> <button type="button" class="btn btn-primary">Create Content</button></a>
