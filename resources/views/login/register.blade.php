                ...
                <form    method="post" enctype="multipart/form-data">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            ...
                            <input name=""  type="password" id="exampleInputPassword2">
                            <i class="ti-lock"></i>
                            <div class="text-danger"></div>
                        </div>
                        ...
                        <div class="form-gp">
                            ...
                            <input name="phoneno"  type="text" id="exampleInputName1">
                            <i class="ti-user"></i>
                            <div class="text-danger"></div>
                        </div>

                        <div class="form-gp">
                            <label for="exampleInputName1">Admin/Creator/Manager/User</label>
                            <input  name="type"  type="text" id="exampleInputName1">
                            <i class="ti-user"></i>
                            <div class="text-danger"></div>
                        </div>
                        ...
                        <div class="form-gp">
                            ...
                            <input name="profilepic"  type="file" id="exampleInputName1">
                            <i class="ti-user"></i>
                            <div class="text-danger"></div>
                        </div>
